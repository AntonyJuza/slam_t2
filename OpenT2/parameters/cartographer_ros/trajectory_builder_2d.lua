...
TRAJECTORY_BUILDER_2D = {
  ...
  voxel_filter_size = 0.005,--此值越小，得到的数据越稠密，但是计算量越高；此值越大，丢失数据越多，但计算更快。
  ...
  ceres_scan_matcher = {--用于高质量的传感器场合
    occupied_space_weight = 30.,--占用空间（扫描点）
    translation_weight = 300.,
    rotation_weight = 60.,--PoseExtrapolator或者RealTimeCorrelativeScanMatcher的权重
