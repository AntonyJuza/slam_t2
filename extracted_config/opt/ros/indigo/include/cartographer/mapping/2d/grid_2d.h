...
class Grid2D : public GridInterface {
 public:
  ...
  virtual std::vector<std::pair<Eigen::Vector2f,Eigen::Vector2f>> GetFitLine() const =0;
  virtual std::vector<Eigen::Vector2f> GetFillPts() const =0;
  virtual std::vector<Eigen::Vector2f> GetEliPts() const =0;
  virtual std::vector<Eigen::Vector2f> GetFitPts() const =0;
