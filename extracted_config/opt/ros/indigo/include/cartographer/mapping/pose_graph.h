...
class PoseGraph : public PoseGraphInterface {
 public:
  ...
  virtual void SetInitialMap(const std::vector<float>& cost_cells,const int width,const int height,const float resolution,const double origin_x,const double origin_y) = 0;
