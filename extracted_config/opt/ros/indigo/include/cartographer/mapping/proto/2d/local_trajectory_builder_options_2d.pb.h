...
class LocalTrajectoryBuilderOptions2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D) */ {
 public:
  ...
  // .cartographer.sensor.proto.AdaptiveVoxelFilterOptions sharpedge_voxel_filter_options = 21;
  bool has_sharpedge_voxel_filter_options() const;
  void clear_sharpedge_voxel_filter_options();
  static const int kSharpedgeVoxelFilterOptionsFieldNumber = 21;
  const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions& sharpedge_voxel_filter_options() const;
  ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* mutable_sharpedge_voxel_filter_options();
  ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* release_sharpedge_voxel_filter_options();
  void set_allocated_sharpedge_voxel_filter_options(::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* sharpedge_voxel_filter_options);
  ...
  // bool use_imu_filter = 22;
  void clear_use_imu_filter();
  static const int kUseImuFilterFieldNumber = 22;
  bool use_imu_filter() const;
  void set_use_imu_filter(bool value);

  // bool support_vslam = 23;
  void clear_support_vslam();
  static const int kSupportVslamFieldNumber = 23;
  bool support_vslam() const;
  void set_support_vslam(bool value);
  ...
  static const int kMaxPitchFieldNumber = 18;
  double max_pitch() const;
  void set_max_pitch(double value);

  // int32 sum_scan_numbers = 300;
  void clear_sum_scan_numbers();
  static const int kSumScanNumbersFieldNumber = 300;
  ::google::protobuf::int32 sum_scan_numbers() const;
  void set_sum_scan_numbers(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* sharpedge_voxel_filter_options_;
  float min_z_;
  float max_z_;
  ...
  double max_pitch_;
  ::google::protobuf::int32 sum_scan_numbers_;
...
// int32 sum_scan_numbers = 300;
inline void LocalTrajectoryBuilderOptions2D::clear_sum_scan_numbers() {
  sum_scan_numbers_ = 0;
}
inline ::google::protobuf::int32 LocalTrajectoryBuilderOptions2D::sum_scan_numbers() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.sum_scan_numbers)
  return sum_scan_numbers_;
}
inline void LocalTrajectoryBuilderOptions2D::set_sum_scan_numbers(::google::protobuf::int32 value) {
  
  sum_scan_numbers_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.sum_scan_numbers)
}
...
// .cartographer.sensor.proto.AdaptiveVoxelFilterOptions sharpedge_voxel_filter_options = 21;
inline bool LocalTrajectoryBuilderOptions2D::has_sharpedge_voxel_filter_options() const {
  return this != internal_default_instance() && sharpedge_voxel_filter_options_ != NULL;
}
inline void LocalTrajectoryBuilderOptions2D::clear_sharpedge_voxel_filter_options() {
  if (GetArenaNoVirtual() == NULL && sharpedge_voxel_filter_options_ != NULL) delete sharpedge_voxel_filter_options_;
  sharpedge_voxel_filter_options_ = NULL;
}
inline const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions& LocalTrajectoryBuilderOptions2D::sharpedge_voxel_filter_options() const {
  const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* p = sharpedge_voxel_filter_options_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.sharpedge_voxel_filter_options)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions*>(
      &::cartographer::sensor::proto::_AdaptiveVoxelFilterOptions_default_instance_);
}
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions2D::mutable_sharpedge_voxel_filter_options() {
  
  if (sharpedge_voxel_filter_options_ == NULL) {
    sharpedge_voxel_filter_options_ = new ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions;
  }
  // @@protoc_insertion_point(field_mutable:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.sharpedge_voxel_filter_options)
  return sharpedge_voxel_filter_options_;
}
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions2D::release_sharpedge_voxel_filter_options() {
  // @@protoc_insertion_point(field_release:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.sharpedge_voxel_filter_options)
  
  ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* temp = sharpedge_voxel_filter_options_;
  sharpedge_voxel_filter_options_ = NULL;
  return temp;
}
inline void LocalTrajectoryBuilderOptions2D::set_allocated_sharpedge_voxel_filter_options(::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* sharpedge_voxel_filter_options) {
  delete sharpedge_voxel_filter_options_;
  sharpedge_voxel_filter_options_ = sharpedge_voxel_filter_options;
  if (sharpedge_voxel_filter_options) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_set_allocated:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.sharpedge_voxel_filter_options)
}
...
// double max_pitch = 18;
inline void LocalTrajectoryBuilderOptions2D::clear_max_pitch() {
  max_pitch_ = 0;
}
inline double LocalTrajectoryBuilderOptions2D::max_pitch() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.max_pitch)
  return max_pitch_;
}
inline void LocalTrajectoryBuilderOptions2D::set_max_pitch(double value) {
  
  max_pitch_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.max_pitch)
}

// bool use_imu_filter = 22;
inline void LocalTrajectoryBuilderOptions2D::clear_use_imu_filter() {
  use_imu_filter_ = false;
}
inline bool LocalTrajectoryBuilderOptions2D::use_imu_filter() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.use_imu_filter)
  return use_imu_filter_;
}
inline void LocalTrajectoryBuilderOptions2D::set_use_imu_filter(bool value) {
  
  use_imu_filter_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.use_imu_filter)
}

// bool support_vslam = 23;
inline void LocalTrajectoryBuilderOptions2D::clear_support_vslam() {
  support_vslam_ = false;
}
inline bool LocalTrajectoryBuilderOptions2D::support_vslam() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.support_vslam)
  return support_vslam_;
}
inline void LocalTrajectoryBuilderOptions2D::set_support_vslam(bool value) {
  
  support_vslam_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.support_vslam)
}
