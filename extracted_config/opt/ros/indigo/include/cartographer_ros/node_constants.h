...
constexpr char   kOdometryTopic[]               = "odom_combined";
...
constexpr char   kPbstreamServiceName[]         = "handle_pbstream";
constexpr char   kManualLoopServiceName[]       = "manual_loop_closure";
constexpr char   kWriteVslamPose[]       = "write_vslam_pose";
