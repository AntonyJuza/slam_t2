...
"""autogenerated by genpy from cartographer_ros_msgs/GetSubmapRequest.msg. Do not edit."""
import sys
...
class GetSubmapRequest(genpy.Message):
  _md5sum = "74e8f1e9dcff0b323f29cf3759b56d04"
  _type = "cartographer_ros_msgs/GetSubmapRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
int32 submap_index
bool write_map
"""
  __slots__ = ['submap_index','write_map']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.submap_index is None:
        self.submap_index = 0
      if self.write_map is None:
        self.write_map = False
    else:
      self.submap_index = 0
      self.write_map = False
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_iB.pack(_x.submap_index, _x.write_map))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.submap_index, _x.write_map,) = _struct_iB.unpack(str[start:end])
      self.write_map = bool(self.write_map)
      return self
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cartographer_ros_msgs/GetSubmapResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetSubmapResponse(genpy.Message):
  ...
  _type = "cartographer_ros_msgs/GetSubmapResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class GetSubmap(object):
  _type          = 'cartographer_ros_msgs/GetSubmap'
  _md5sum = 'd186db8adc3c0aec02e182098a6cf86e'
