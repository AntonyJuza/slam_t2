...
if("FALSE" STREQUAL "TRUE")
  set(gmapping_SOURCE_PREFIX /workdir/catkin_ws/src/keenon_ros/keenon_slam/slam_gmapping/gmapping)
  set(gmapping_DEVEL_PREFIX /workdir/catkin_ws/src/keenon_ros/keenon_slam/slam_gmapping/gmapping/obj-x86_64-linux-gnu/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Li Yinxuan <liyx@keenonrobot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Li Yinxuan <liyx@keenonrobot.com>' to fix it.")
    endif()
